...
from data_utils import DataCollatorWithPadding, Config, pack_examples, get_mdpi_mtb_dataloaders, reset_mdpi_mtb_dataloader, get_nhs_dataloaders
...
def train_function(config):
    ...
    printm((len(train_dataloader), max_steps))
    ...
    load_model(model, training_args.ckpt_dir, rank) # TODO: remove
    printm(f"Mode loaded from {training_args.ckpt_dir}")
    # if checkpoint:
...
if __name__ == '__main__':
    ...
    config.train.hf_training_arguments["ckpt_dir"] = args.ckpt_dir
    setup()
