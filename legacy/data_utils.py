...
def get_nhs_dataloaders(
    ...
    train_dataloader = DataLoader(
        train_dataset, shuffle=False, collate_fn=dc, batch_size=train_bs, sampler=train_sampler,
    )

    eval_dataloader = DataLoader(
        test_dataset, shuffle=False, collate_fn=dc, batch_size=eval_bs, sampler=test_sampler,
    )
